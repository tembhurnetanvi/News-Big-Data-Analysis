...
def page_second():
    ...
    audio_backend = f'https://news-analysis-px7gwe6txq-ue.a.run.app/opinion/{int_val}/text-to-speech'
...
def page_third():
    ...
    if nlp_option=="Sentiment":
        st.write("# Sentiment")
        backend = f'https://news-analysis-px7gwe6txq-ue.a.run.app/opinion/{x}/sentiment'
    ...
    if nlp_option=="Summarization":
        ...
        backend = f'https://news-analysis-px7gwe6txq-ue.a.run.app/opinion/{x}/summarizer'
