...
def page_second():
    ...
    audio_backend = f'https://news-analysis-px7gwe6txq-uk.a.run.app/tech/{int_val}/text-to-speech'
...
def page_third():
    ...
    if nlp_option=="Sentiment":
        st.write("# Sentiment")
        backend = f'https://news-analysis-px7gwe6txq-uk.a.run.app/tech/{x}/sentiment'
    ...
    if nlp_option=="Summarization":
        ...
        backend = f'https://news-analysis-px7gwe6txq-uk.a.run.app/tech/{x}/summarizer'
