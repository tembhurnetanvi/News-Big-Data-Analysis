...
def page_second():
    ...
    audio_backend = f'https://news-analysis-px7gwe6txq-ue.a.run.app/politics/{int_val}/text-to-speech'
    audio = process_tts(audio_backend)
    if audio:
        st.audio(f'https://news-analysis-px7gwe6txq-ue.a.run.app/politics/{int_val}.mp3', format='audio/ogg')
...
def page_third():
    ...
    if nlp_option=="Sentiment":
        st.write("# Sentiment")
        backend = f'https://news-analysis-px7gwe6txq-ue.a.run.app/politics/{x}/sentiment'
    ...
    if nlp_option=="Summarization":
        ...
        backend = f'https://news-analysis-px7gwe6txq-ue.a.run.app/politics/{x}/summarizer'
