...
def page_second():
    ...
    DATA_URL="https://storage.googleapis.com/news_articles_scraped/CNN/us.csv"
    ...
    audio_backend = f'https://news-analysis-px7gwe6txq-ue.a.run.app/us/{int_val}/text-to-speech'
    audio = process_tts(audio_backend)
    if audio:
        st.audio(f'https://storage.googleapis.com/audio-output/us/{int_val}.mp3', format='audio/ogg')
...
def page_third():
    ...
    if nlp_option=="Sentiment":
        st.write("# Sentiment")
        backend = f'https://news-analysis-px7gwe6txq-ue.a.run.app/us/{x}/sentiment'
    ...
    if nlp_option=="Summarization":
        ...
        backend = f'https://news-analysis-px7gwe6txq-ue.a.run.app/us/{x}/summarizer'
